...
class Result(models.Model):
    counselor = models.ForeignKey(Counselor, models.CASCADE, db_column='Counselor_id')  # Field name made lowercase.
    counselee = models.ForeignKey(Counselee, models.CASCADE, db_column='Counselee_id')  # Field name made lowercase.
